...
const translations: Record<Language, Record<string, string>> = {
    EN: {
        ...
        'dashboard.underConstruction': 'This page is under construction or restricted to administrators.',
    ...
    ID: {
        ...
        'about.bio1': 'Saya Bima Satya Mahendra (Satya), saat ini sedang menempuh pendidikan di Jurusan Informatika, Institut Teknologi Sumatera. Saya memiliki minat dalam pengembangan rekayasa perangkat lunak, web3, teknologi blockchain, dan AI, terutama web3 dan AI. Saya telah menghabiskan sebagian besar waktu saya untuk membangun proyek dan meningkatkan keterampilan saya di bidang-bidang tersebut.',
